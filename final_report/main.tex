...
\icmltitlerunning{Reducing False Positives in Real-Time Forest Fire Detection via Semantic Verification}
...
\textbf{Code:} \url{https://github.com/<USERNAME>/dl-forest-fire-detection}\par}
\vskip 0.20in
]
